    ...
    <div class="row">
      ...
      <div class="col-5">
        <form name="addBook" id="addBook" action="controller" method="POST">
          ...
          <div class="mb-1">
            <label for="author" class="col-form-label">Автор книги:</label>
        ...
        <form id="addAuthor" action="controller" method="POST">
          ...
          <div class="mb-3">
             <label for="name" class="col-form-label">ФИО автора:</label>
        ...
        <form id="searchByYearPagesTitle" action="controller">
          ...
          <div class="mb-3">
            <label for="title" class="col-form-label">Часть названия книги:</label>
